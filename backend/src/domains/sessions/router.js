 ...
 *   put:
 *     summary: Finalizar sesión desde Dashboard
 *     tags: [Sesiones Receta VR]
 *     security:
 *       - bearerAuth: []
 *     description: |
 *       Permite a un terapeuta/superadmin cerrar manualmente una sesión en estado
 *       CREATED o ACTIVE.
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *       400:
 *         description: La sesión ya estaba finalizada
 *       401:
 *         description: No autenticado
 *       403:
 *         description: Sin permisos sobre la sesión
 *       404:
