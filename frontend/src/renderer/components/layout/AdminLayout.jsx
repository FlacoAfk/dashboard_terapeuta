 ...
 * Incluye header, sidebar responsivo y área de contenido
 */
                            ...
                            <>
                                ...
                                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg py-1 z-20">
                                    <div className="px-4 py-2 border-b border-gray-100">
                                        <p className="text-sm font-medium text-gray-900 truncate" title={(user?.nombre && user.nombre !== user?.email && user.nombre !== user?.correo) ? user.nombre : 'Administrador'}>
                                            {(user?.nombre && user.nombre !== user?.email && user.nombre !== user?.correo)
                                                ? user.nombre
                                                : 'Administrador'}
                                        </p>
                                        <p className="text-xs text-gray-500 truncate" title={user?.email || user?.correo}>{user?.email || user?.correo}</p>
                                    </div>
                                    <button
